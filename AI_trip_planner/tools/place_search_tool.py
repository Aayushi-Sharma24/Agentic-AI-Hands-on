...
class PlaceSearchTool:
    def __init__(self):
        load_dotenv()
        self.google_api_key = os.environ.get("GEOAPIFY_API_KEY")
        # self.google_places_search = GooglePlaceSearchTool(self.google_api_key)
        self.geoapify = GeoapifyPlaceSearchTool()
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            try:
                attraction_result = self.geoapify.search_attractions(place)
        ...
        def search_restaurants(place:str) -> str:
            ...
            try:
                restaurants_result = self.geoapify.search_restaurants(place)
        ...
        def search_activities(place:str) -> str:
            ...
            try:
                activities_result = self.geoapify.search_activity(place)
        ...
        def search_transportation(place:str) -> str:
            ...
            try:
                transportation_result = self.geoapify.search_transportation(place)
